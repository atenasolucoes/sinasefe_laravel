...
<head>
    ...
    <title>SINASEFE - IF SERTAO-PE</title>
...
<body style="margin: 0px;">
    ...
    <header class="container-fluid">
        <div class="row" style=" background-color: darkred; color: white;">
            <div class="col-sm-7 tel-email" style="padding: 10px;">
                (87) 98812-1921 | sinasefe@ifsertao-pe.edu.br
            </div>
            <div class="col-sm-5">
                <div class="row">
                    <div class="col-sm-3 text-center " style="background: white; padding: 0px;">
                        <a href="#" class="btn btn-light" style="text-decoration: none; color: darkred;  padding: 10px; width: 100%; border-radius: 0px; height: auto;">FILIE-SE</a>
                    </div>
                    <div class="col-sm-9 text-center" >
                        <div class="row" style="padding: 10px;">
                            <div class="col-sm-7 redes-sociais rs">
                               <ul>
                        <a href="https://www.facebook.com/sinasefesertaope/" target="_blank"><li><img src="imagens/face.png" style="  filter: brightness(0) invert(1);"></li></a>
                        <a href="http://www.instagram.com/sinasefesertaope" target="_blank"><li><img src="imagens/insta.png" style="  filter: brightness(0) invert(1);"></li></a>
                        <a href="https://www.youtube.com/channel/UC00xQmSzJSxdQtsNSSfBQSA/" target="_blank"><li><img src="imagens/youtube.png" width="80px" style="  filter: brightness(0) invert(1);"></li></a>
                        <a href="http://web.whatsapp.com" target="_blank"><li><img src="imagens/whats.png" width="80px" style="  filter: brightness(0) invert(1);"></li></a></ul>
                            </div>
                            <div class="col-sm-5">
...
<!--   
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="contato">
                        ...
                        <ul>
                            <li><div class="icones"> <i class="material-icons">explore</i></div> Av. Souza Filho, Nº 842, Galeria Alameda Center, Sala 104, 1º andar, Centro - Petrolina/PE</li>
                            <li><div class="icones"><i class="material-icons">stay_current_portrait</i></div> (87) 98812-1921
                            <li><div class="icones"></div>Estamos no Whatsapp das 13h às 17h, de segunda à sexta-feira</li>
                            <li><div class="icones"><i class="material-icons">public</i></div> sinasefe@ifsertao-pe.edu.br</li>
                        </ul>
                    </div>
                </div>
            ...
            <p>   <a href="#" data-toggle="modal" data-target="#login" style="text-decoration: none; color: white; vertical-align: middle; float: right; "><i class="material-icons" style="font-size:40px; ">lock</i></a></p>
        </div>
        <div class="desenvolvimento" style="padding: 10px; height: auto;">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 sinasefe" style="color: white;">
                    Copyright © <?php $data =date("Y"); echo $data; ?> - SINASEFE IF SERTÃO-PE - Todos os direitos reservados.
